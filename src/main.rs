...
const API_BASE: &str = "https://dev.api.treklabs.xyz/api/v1";
const WSS_URL: &str = "wss://dev.ws.treklabs.xyz/stream";
    ...
    let _ = tokio::spawn({
        ...
        async move {
            ...
            loop {
                ...
                let Ok(request) =
                    reqwest::get(format!("{API_BASE}/depth?symbol=NOTSOL_USDC")).await
                else {
